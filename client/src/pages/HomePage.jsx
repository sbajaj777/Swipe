...
const HomePage = () => {
	...
	const handleFilter = () => {
		applyCityFilter(cityInput.trim());
	};
	...
	return (
		<div className='flex flex-col lg:flex-row min-h-screen bg-gradient-to-br from-pink-100 to-purple-100 overflow-hidden'>
			...
			<div className='flex-grow flex flex-col overflow-hidden'>
				<Header />
				<main className='flex-grow flex flex-col gap-6 justify-start items-center p-4 relative overflow-hidden'>
					<div className='w-full max-w-sm mt-4'>
						<input
							type='text'
							placeholder='Type city name (leave blank to see all)'
							value={cityInput}
